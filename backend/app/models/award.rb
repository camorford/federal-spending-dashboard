class Award < ApplicationRecord
  ...
  searchkick word_start: [:recipient_name, :description, :agency_name],
            searchable: [:recipient_name, :description, :agency_name],
            filterable: [:agency_id, :award_type, :place_of_performance_state]
